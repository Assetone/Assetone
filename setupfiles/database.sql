...
ALTER TABLE `components`
  ADD PRIMARY KEY (`ID`), ADD KEY `ctID` (`ctID`), ADD KEY `rID` (`rID`);
...
ALTER TABLE `user`
  ADD PRIMARY KEY (`ID`), ADD KEY `ugID` (`ugID`);
...
ADD CONSTRAINT `components_ibfk_2` FOREIGN KEY (`rID`) REFERENCES `rooms` (`ID`);

ALTER TABLE `user`
ADD CONSTRAINT `user_ibfk_1` FOREIGN KEY (`ugID`) REFERENCES `usergroup` (`ID`);
COMMIT;
